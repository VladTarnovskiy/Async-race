...
export default class Car {
  draw(data: CarItem): void {
    ...
    buttonRemove.className = 'button car__but car__but_remove';
    ...
    const buttonCarStart = <HTMLElement>document.createElement('button');
    buttonCarStart.className = 'button car__but-drive car__but_drive';
    ...
    blockDrive.appendChild(buttonCarStop);
    ...
    imgCar.className = 'car__img';
    imgCar.innerHTML = carImg;

    const imgFlag = <HTMLElement>document.createElement('div');
    imgFlag.className = 'car__flag';
