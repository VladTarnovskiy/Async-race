export default class CarWinner {
  draw(): void {
    ...
    const mainCar = <HTMLElement>document.createElement('div');
    mainCar.className = 'table__main-item table__main_car';

    const mainCarImg = <HTMLElement>document.createElement('div');
    mainCarImg.className = 'table__main_car-img';
    mainCarImg.innerHTML = carImg;

    mainCar.appendChild(mainCarImg);
    ...
    winnersTableMain.appendChild(mainName);
    winnersTableMain.appendChild(mainWins);
    winnersTableMain.appendChild(mainTime);

    container.appendChild(winnersTableMain);
  }
}
